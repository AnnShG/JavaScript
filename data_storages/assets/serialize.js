...
//  If we have a form on a website and we want to make a JSON call, we choose  a json format, 
//  then we need to gather all the information inside the js object, we need to translate it into JSON, and then it can be send to our backend.
